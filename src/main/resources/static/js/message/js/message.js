...
;(function(global,$){
	 ...
	 */
	 var cssMap={
		...
		'.toast-message--info':'{border-color:#EBEEF5;background-color:#edf2fc;border-radius:20px;font-style: normal;}',
		...
		'.toast-message--success':'{border-color:#e1f3d8;background-color:#f0f9eb;border-radius:20px;font-style: normal;}',
		...
		'.toast-message--warning':'{border-color:#faecd8;background-color:#fdf6ec;border-radius:20px;font-style: normal;}',
		...
		'.toast-message--error':'{border-color:#fde2e2;background-color:#fef0f0;font-weight:bold;border-radius:20px;font-style: normal;}',
